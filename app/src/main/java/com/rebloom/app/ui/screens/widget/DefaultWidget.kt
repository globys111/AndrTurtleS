...
class DefaultWidget : GlanceAppWidget() {
    override suspend fun provideGlance(context: Context, id: GlanceId){provideContent{Column {Image(provider = ImageProvider(R.drawable.bad_widget), contentDescription = "Маскот", modifier = Modifier.fillMaxWidth().padding(8.dp))}}}}
